...
class LetterCell: UICollectionViewCell {
    ...
    func set(style: LetterCellStyle) {
        ...
        case .initial:
            ...
            layer.borderColor = UIColor.gray.cgColor
        case .incorrect:
            contentView.backgroundColor = UIColor(red: 0.21, green: 0.22, blue: 0.21, alpha: 1.0)
            layer.borderColor = UIColor(red: 0.21, green: 0.22, blue: 0.21, alpha: 1.0).cgColor
        case .correctLetterOnly:
            contentView.backgroundColor = UIColor(red: 0.63, green: 0.62, blue: 0.27, alpha: 1.0)
            layer.borderColor = UIColor(red: 0.63, green: 0.62, blue: 0.27, alpha: 1.0).cgColor
        case .correctLetterAndPosition:
            contentView.backgroundColor = UIColor(red: 0.30, green: 0.51, blue: 0.30, alpha: 1.0)
            layer.borderColor = UIColor(red: 0.30, green: 0.51, blue: 0.30, alpha: 1.0).cgColor
        }
